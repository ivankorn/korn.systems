...
- **Availability**: Open for international contracts (Fixed hourly/day rate in USD/EUR/GBP)
...
- **Cloud & Solutions Architecture**: AWS, Google Cloud Platform (GCP), Azure, Hybrid Clouds, Serverless, Edge Computing. (Contributor to the Google Cloud Foundation Toolkit and HashiCorp GitHub organization).
- **Containerization & Orchestration**: Kubernetes (GKE, EKS, AKS, K3s, bare-metal), Docker, Helm 3, Gateway API.
- **Infrastructure as Code (IaC)**: Terraform, OpenTofu, Terragrunt, Ansible, Chef.
- **CI/CD & GitOps**: ArgoCD, GitHub Actions, GitLab CI/CD, Jenkins, Azure DevOps, Google Cloud Build.
- **DevSecOps & Platform Security**: Secrets Management (GCP Secret Manager, AWS Secrets Manager, HashiCorp Vault, SOPS, External Secrets Operator), CI/CD Security Scans (Trivy, CodeQL, SonarQube).
- **MLOps & AI Reliability**: AWS Karpenter and GKE autoscaling for GPU/CPU workloads, orchestrating model inference setups, and compliance monitoring.
- **Team Leadership & Mentor**: Managing engineering teams, designing training programs (DevOps Base Camp programs for GlobalLogic and EPAM), and coaching full-time client teams.
...
- **Master of Science (M.S.) in Computer Science**
  National Technical University of Ukraine "Kyiv Polytechnic Institute" (IASA)
  _Specialization_: Computer Systems Engineering
  _Diploma Project_: Web service for virtualized desktops and applications
- **Bachelor of Science (B.S.) in Computer Science**
  National Technical University of Ukraine "Kyiv Polytechnic Institute" (IASA)
  _Diploma Project_: Analysis of modern operating system virtualization technologies
